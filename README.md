...
[Text Translator Demo](add video)<br><br>
...
[Switch Translation Demo](add video)<br><br>

3. **Translate File**

The translate file use case allows... (1 sentence)

<ins>Example user story:</ins>

<ins>Example use case tutorial:</ins>

[Translate File Demo](add video)<br><br>

4. **Translate Image**

The translate image use case allows... (1 sentence)

<ins>Example user story:</ins>

<ins>Example use case tutorial:</ins>

[Translate Image Demo]()<br><br>

5. **Check Usage**

The check usage use case allows... (1 sentence)

<ins>Example user story:</ins>

<ins>Example use case tutorial:</ins>

[Check Usage Demo](add video)<br><br>
